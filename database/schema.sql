...
INSERT INTO `users` (`email`, `password`, `created_at`, `token`, `active`, `verified`) VALUES
('user1@example.com', '$2a$12$vChxDZJ8me0zA2gWMwq7MOcNYScff4xe6mIv/xEJNwfRDpVSXcure', current_timestamp(), NULL, 1, NULL),
('user2@example.com', '$2a$12$vChxDZJ8me0zA2gWMwq7MOcNYScff4xe6mIv/xEJNwfRDpVSXcure', current_timestamp(), NULL, 1, 'verified2');

-- Insert dummy data into books table
INSERT INTO `books` (`isbn`, `title`, `author`, `genre`, `descriptions`, `price`) VALUES
('978-3-16-148410-0', 'Sapiens', 'Anthro', 'Reality', 'Human Kind Development', 19.99),
